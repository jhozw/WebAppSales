...
namespace SalesWebMvc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppWebMvcSalesContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("AppWebMvcSalesContext") ?? throw new InvalidOperationException("Connection string 'AppWebMvcSalesContext' not found.")));

            services.AddScoped<SeedingService>();
            //services.AddScoped<SellerService>();
            services.AddScoped<Departament>();
